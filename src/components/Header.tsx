...
export default function Header(): JSX.Element {
  ...
  return (
    <>
      ...
      {showInfo && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-xs flex items-center justify-center md:items-end md:justify-center z-[1000] p-8 md:p-0 overflow-y-auto animate-fadeIn">
          <div className="bg-white rounded-2xl md:rounded-t-2xl md:rounded-b-none p-10 md:p-8 max-w-[650px] w-full max-h-[85vh] md:max-h-[90vh] overflow-y-auto overflow-x-hidden relative shadow-2xl animate-fadeInSlow md:animate-slideUp custom-scrollbar">
            <button
